...
from ollama_AI       import structure_summary_en, translate_json_ja_ultra_safe,warmup_model
from qiita_publish   import make_intro_md,to_qiita_md, post_to_qiita
...
DATE = str(date.today())
QIITA_TITLE = 'arXiv論文自動要約 投稿日：' + DATE
